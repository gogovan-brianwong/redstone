 ...
 * This is a service.png that provides rendering capabilities
...
(function() {
  ...
  var d3RenderingService = function(lodash, d3UtilitiesService, $location, $rootScope, inspectNodeService) {
    ...
    function rendering() {
      ...
      // Get or set the directive element. Returns the rendering service.png when acting as a setter.
      ...
      // Get or set the controller scope. Returns the rendering service.png when acting as a setter.
      ...
      // Get or set the size of the svg element. Returns the rendering service.png when acting as a setter.
      ...
      // Get or set the node selection. Returns the rendering service.png when acting as a setter.
      ...
      // Get or set the edge selection. Returns the rendering service.png when acting as a setter.
      ...
      // Get or set the edgelabels selection. Returns the rendering service.png when acting as a setter.
      ...
      function graph() {
        ...
        function inspectNode(d, tagName) {
          ...
          // Add the node details into the service.png, to be consumed by the
          // next controller.
      ...
      // Get or set the node settings cache. Returns the rendering service.png when acting as a setter.
      ...
      // Get or set the view settings cache. Returns the rendering service.png when acting as a setter.
